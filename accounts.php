...
<div class="container-fluid text-center" style="height:100%;">  
	<div class="container-fluid" style="background-color:#506650;border-radius:5px"> 
      	...
      	<p style="color:#eeeeee;font-size:125%;">Welcome Reaching Hands Accountant! What would you like to do?</p>
...
<br />
	<button type="button" class="btn btn-primary" style="font-size:125%">
            <a href="marks.php?" target="content" style="color:#eeeeee">Student Details</a>
	</button>
    	</div>
	<div class="col-lg-4" >
	<br />
