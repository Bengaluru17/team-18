  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="destroy_session.php" style="font-size:125%"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<br />
	<button type="button" class="btn btn-primary" style="font-size:250%">
	    <a href="get_inv.php?" target="content" style="color:#eeeeee">Inventory</a>
	</button>
    	</div>
        <div class="col-lg-4">
	<br />
